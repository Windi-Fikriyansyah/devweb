        ...
        <article className="min-h-screen bg-white dark:bg-zinc-950 pb-24 selection:bg-blue-100 selection:text-blue-900">
            ...
            <div className="container mx-auto px-4 max-w-4xl relative z-10 pt-12">
                ...
                <header className="mb-16">
                    ...
                    <div className="flex flex-wrap items-center gap-x-10 gap-y-6 text-gray-500 dark:text-gray-400 text-xs font-bold uppercase tracking-widest pb-12">
                        <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-full bg-blue-600 flex items-center justify-center text-white text-sm font-black ring-8 ring-blue-50 dark:ring-blue-900/10">
                                {article.author.charAt(0)}
                            </div>
                            <div>
                                <p className="text-[10px] text-gray-400 mb-0.5">Penulis</p>
                                <p className="text-gray-900 dark:text-gray-200">{article.author}</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col md:flex-row gap-16">
                    ...
                    {/* Article Body */}
                    <div className="flex-1 max-w-3xl prose prose-lg dark:prose-invert prose-headings:font-black prose-headings:tracking-tight prose-p:text-gray-600 dark:prose-p:text-gray-300 prose-p:leading-relaxed prose-blue">
                        <div className="whitespace-pre-wrap text-xl md:text-2xl font-medium leading-relaxed text-gray-800 dark:text-gray-200">
                            {article.content}
                        </div>
                    </div>
                </div>
